...
if (isset($_GET['search'])) {
    if (isset($_GET['search-basis']) && !empty($_GET['search-basis'])) {
        $keyword = $controller->clean_encode($_GET['search-basis']);
        ...
        if ($found_entries) {
            ...
            echo "<div class='entry error'>Keine Beiträge für \"$keyword\" gefunden!</div>";
        }
        ...
        if ($found_users) {
            ...
            echo "<div class='entry error'>Keine Benutzer mit \"$keyword\" gefunden!</div>";
        }
    }
